...
import com.ecommerce.inventory_managment_system.exceptions.UnauthorizedException;
import com.ecommerce.inventory_managment_system.properties.JwtProperties;
...
public class JwtTokenService {
    ...
    public String generateAccessToken(@Nonnull final String tenantId , @Nonnull final String userId , final String role)
    {
