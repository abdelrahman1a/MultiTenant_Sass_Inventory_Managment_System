...
import com.ecommerce.inventory_managment_system.config.TenantSchemaResolver;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        try{
            ...
            if(StringUtils.hasText(jwtToken) && this.jwtTokenService.validateToken(jwtToken) )
            {
                final String userId = this.jwtTokenService.getUserIdFromToken(jwtToken);
                final String tenantId = this.jwtTokenService.getTenantIdFromToken(jwtToken);
                final String role = this.jwtTokenService.getRoleFromToken(jwtToken);
