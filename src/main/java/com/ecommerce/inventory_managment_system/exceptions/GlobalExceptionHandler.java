...
import com.ecommerce.inventory_managment_system.exceptions.responses.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleException(final BuisnessException ex ,
    ...
    private HttpStatus getHttpStatus(BuisnessException ex)
    {
